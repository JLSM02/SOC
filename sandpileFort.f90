...
subroutine genAnimData (l, limit, frames, bdt, randomness)
    ...
    real :: r_randy, r_randx, r_randn
    logical :: next_sand, topling
    integer :: M(l, l), Queue(2,l*l), nf_Queue(2,l*l), F(l,l), A(l, l)
...
subroutine noHomogSimulation (l, statistic, bdt, randomness, filename)
    implicit none

    ! Input arguments
    integer, intent(in) :: l, statistic
    logical, intent(in) :: randomness
    character(len=6), intent(in) :: bdt, filename
    ...
    real :: r_randy, r_randx, r_randn
    logical :: next_sand, topling
    integer :: M(l, l), Queue(2,l*l), nf_Queue(2,l*l), Limit(l, l)
    !integer :: A(l,l) !Enable if want to compute the area

    !Initialize a matrix for check the limit in each
...
end subroutine noHomogSimulation